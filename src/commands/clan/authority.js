...
module.exports = {
    async execute(interaction, userClanData, permissions) {
        ...
        if (targetUser.id === userClanData.clanOwnerUserID) return interaction.reply({ content: "The Clan Owner's authority cannot be changed with this command.", ephemeral: true });
